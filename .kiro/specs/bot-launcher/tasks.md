...
- [x] 1. Crear página `ui/src/pages/Launcher.tsx`
...
- [x] 2. Implementar `ProcessSelector` como componente interno
...
- [x] 3. Implementar `RobotSelector` como componente interno
...
- [x] 4. Implementar `ParameterForm` para tipos String, Int32, Boolean, DateTime
...
- [x] 5. Implementar LaunchButton con estado de loading
...
- [x] 6. Implementar panel Recent Jobs con auto-refresh
...
- [x] 7. Registrar ruta `/launcher` en el router y añadir entrada en sidebar
...
- [x] 8. Verificar build TypeScript: `npm run build`
  **Acceptance criteria:** Build pasa sin errores.

- [x] 9. Commit: `feat: Bot Launcher - one-click unattended bot execution`
