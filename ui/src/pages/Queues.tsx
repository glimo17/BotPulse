...
export default function Queues() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold text-gray-100">{t('queues.title')}</h1>
              ...
              <div key={q.externalId} className="card p-4 space-y-3">
                <div className="flex items-start justify-between">
                  ...
                  <span className={clsx('text-xs font-bold px-2 py-0.5 rounded-full',
                    ...
                    q.pendingItems > 500  ? 'bg-warning/20 text-warning' : 'bg-gray-700 text-gray-400')}>
                    {q.pendingItems} pend.
                  </span>
                </div>
                <div>
                ...
                <div className="flex gap-4 text-xs">
                  ...
                  <span className="text-gray-500">{q.totalItems} total</span>
                </div>
              </div>
            )
          })}
